    -- Instructions:
--After you copying someone's elses arts, remember to change a little bit (the background, color ect) and wait 1 minutes, if you don't do that correctly YOU MIGHT GET PERMA-BANNED;
--DON'T USE CLONER (cloner has been patched and is hightly bannable, you can still use on old servers but i wouldn't recommend).
